...
private:
  ...
  std::vector< QGaussLobatto<1> * >              line_quadrature_collection;
  ...
  std::vector< Tensor<1,dim> >  soln_sigma_face[alphadim];
  std::vector<double>           isoln_alpha_face[alphadim];
  std::vector<double>           soln_alpha_neigh_face[alphadim];
  std::vector< Tensor<1,dim> >  soln_sigma_neigh_face[alphadim];
